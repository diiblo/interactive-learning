...
public sealed class ReactLearningLanguageHandler(StaticSnippetValidationService validationService) : ILearningLanguageHandler
{
    public string CourseLanguage => "react";
